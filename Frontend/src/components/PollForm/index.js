...
function PollForm() {
  ...
  return (
    ...
    <div className="p-4 flex flex-col gap-4 h-screen  m-auto items-center justify-center">
      <div className="flex flex-col gap-3 w-1/2">
        <label htmlFor="question" className="border-2 p-2 rounded w-1/2 flex justify-between">Enter Question and options</label>
        <textarea
          autoFocus
      ...
      <div className="w-1/2 flex justify-between">
        <button className="border-2 p-2 rounded" onClick={handleAddOption}>
          Add another option +
        </button>
        <button className="border-2 p-2 rounded" onClick={handleAskQuestion}>
          Ask question →
        </button>
      </div>
    </div>
